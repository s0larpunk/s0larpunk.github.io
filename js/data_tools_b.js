window._TOOLS_B = [
  {
    id: 'to_participatory_budgeting',
    type: 'tool',
    name: { en: 'Participatory Budgeting', ru: 'Партиципаторный бюджет' },
    emojis: ['🗳️', '💰', '🏘️'],
    quote: {
      en: 'The citizen\'s participation...ceases to be an enabler of traditional politics and becomes a permanent protagonist of public administration.',
      ru: 'Участие граждан...перестаёт быть инструментом традиционной политики и становится постоянным субъектом государственного управления.'
    },
    author: 'Ubiratan de Souza',
    year: '01998',
    explainMore: {
  ...
  },
  {
    id: 'to_agroecology',
    type: 'tool',
    name: { en: 'Agroecology', ru: 'Агроэкология' },
    emojis: ['🌱', '🚜', '🌍'],
    quote: {
      en: 'Agribusiness disrupts the climate. Peasant agriculture protects the Earth.',
      ru: 'Агробизнес нарушает климат. Крестьянское земледелие защищает Землю.'
    },
  ...
  },
  {
    id: 'to_performance',
    type: 'tool',
    name: { en: 'Performance', ru: 'Перформанс' },
    emojis: ['🎭', '📣', '🕺'],
    quote: {
      en: 'To strike a pose is to pose a threat.',
      ru: 'Принять позу — значит создать угрозу.'
    },
    author: 'Dick Hebdige',
    year: '01982',
    explainMore: {
  ...
  },
  {
    id: 'to_photography',
    type: 'tool',
    name: { en: 'Photography', ru: 'Фотография' },
    emojis: ['📷', '👁️', '🌅'],
    quote: {
      en: 'The camera is an instrument that teaches people how to see without a camera.',
      ru: 'Фотоаппарат — это инструмент, который учит людей видеть без фотоаппарата.'
    },
  ...
  {
    id: 'to_public_transport',
    type: 'tool',
    name: { en: 'Public Transport', ru: 'Общественный транспорт' },
    emojis: ['🚌', '🚇', '🌆'],
    quote: {
      en: 'Forget the damned motor car and build cities for lovers and friends.',
      ru: 'Забудьте о проклятом автомобиле и стройте города для влюблённых и друзей.'
    },
  ...
  },
  {
    id: 'to_reparations',
    type: 'tool',
    name: { en: 'Reparations', ru: 'Репарации' },
    emojis: ['⚖️', '✊', '🔄'],
    quote: {
      en: 'The wealth of the imperial countries is our wealth too...It\'s just reparations which will be paid to us.',
      ru: 'Богатство империалистических стран — это и наше богатство тоже...Это всего лишь репарации, которые будут нам выплачены.'
    },
    author: 'Frantz Fanon',
    year: '01961',
    explainMore: {
  ...
  },
  {
    id: 'to_unions',
    type: 'tool',
    name: { en: 'Unions', ru: 'Профсоюзы' },
    emojis: ['✊', '🏭', '📋'],
    quote: {
      en: 'If I admit I\'ve learned something, then it means my entire political project is a lie.',
      ru: 'Если я признаю, что чему-то научился, это означает, что весь мой политический проект — ложь.'
    },
  ...
  },
  {
    id: 'to_satire',
    type: 'tool',
    name: { en: 'Satire', ru: 'Сатира' },
    emojis: ['😂', '🎪', '🗞️'],
    quote: {
      en: 'The Union can only act in a revolutionary way to the extent that the [revolutionary] ideal is given precedence over [reformist] interest.',
      ru: 'Профсоюз может действовать революционно лишь в той мере, в какой [революционный] идеал ставится выше [реформистского] интереса.'
    },
  ...
  },
  {
    id: 'to_upcycling',
    type: 'tool',
    name: { en: 'Upcycling', ru: 'Апсайклинг' },
    emojis: ['♻️', '🔧', '✨'],
    quote: {
      en: 'Often when you think you\'re at the end of something, you\'re at the beginning of something else.',
      ru: 'Часто, когда ты думаешь, что стоишь у конца чего-то, ты стоишь у начала чего-то другого.'
    },
    author: 'Fred Rogers',
    year: '02003',
    explainMore: {
  ...
  {
    id: 'to_vertical_farms',
    type: 'tool',
    name: { en: 'Vertical Farms', ru: 'Вертикальные фермы' },
    emojis: ['🏗️', '🥬', '💡'],
    quote: {
      en: 'It takes a lot of skill to be able to grow food sustainably. It\'s an art form. We need to raise agriculture up...because the food that we eat is the most important thing in our lives.',
      ru: 'Для устойчивого выращивания еды нужно много мастерства. Это форма искусства. Нам нужно поднять сельское хозяйство...потому что еда, которую мы едим, — самое важное в нашей жизни.'
    },
    author: 'Will Allen',
    year: '02016',
    explainMore: {
  ...
  {
    id: 'to_visionary_fiction',
    type: 'tool',
    name: { en: 'Visionary Fiction', ru: 'Визионерская фантастика' },
    emojis: ['📚', '🌠', '✍️'],
    quote: {
      en: 'We live in capitalism. Its power seems inescapable. So did the divine right of kings...Resistance and change often begin in art, and very often in our art, the art of words.',
      ru: 'Мы живём в капитализме. Его власть кажется неизбежной. Так же казалось и о божественном праве королей...Сопротивление и перемены часто начинаются в искусстве, и очень часто в нашем искусстве, в искусстве слова.'
    },
  ...
  },
  {
    id: 'to_carpentry',
    type: 'tool',
    name: { en: 'Carpentry', ru: 'Плотницкое дело' },
    emojis: ['🔨', '🪵', '🏠'],
    quote: {
      en: 'The demands of freedom confront us with a much heavier choice...We will have to physically disassemble much of the world we live in and build it anew.',
      ru: 'Требования свободы ставят нас перед куда более тяжёлым выбором...Нам придётся физически разобрать большую часть мира, в котором мы живём, и построить его заново.'
    },
  ...
  {
    id: 'to_disaster_relief',
    type: 'tool',
    name: { en: 'Disaster Relief', ru: 'Помощь при катастрофах' },
    emojis: ['🆘', '🤝', '⛺'],
    quote: {
      en: 'Dining is a ritual of generosity and hospitality: sharing the riches of one\'s table, welcoming guests, feeding them, providing them with refuge.',
      ru: 'Совместная трапеза — это ритуал щедрости и гостеприимства: разделить богатства своего стола, приветствовать гостей, накормить их, дать им убежище.'
    },
    author: 'Maria Saffiotti Dale',
    year: '02020',
    explainMore: {
  ...
  {
    id: 'to_community_meals',
    type: 'tool',
    name: { en: 'Community Meals', ru: 'Общественные трапезы' },
    emojis: ['🍲', '👐', '🏡'],
    quote: {
      en: 'We see the sense of community and mutual aid that develops in the wake of crisis as fertile ground to merge social movement theory and praxis.',
      ru: 'Мы видим в чувстве общности и взаимопомощи, возникающем вслед за кризисом, плодородную почву для слияния теории социальных движений и практики.'
    },
  ...
  },
  {
    id: 'to_documentation',
    type: 'tool',
    name: { en: 'Documentation', ru: 'Документация' },
    emojis: ['📹', '📝', '🗂️'],
    quote: {
      en: 'My way leads towards the creation of a fresh perception of the world. Thus I explain in a new way the world unknown to you.',
      ru: 'Мой путь ведёт к созданию свежего восприятия мира. Таким образом я объясняю по-новому мир, неизвестный вам.'
    },
    author: 'Dziga Vertov',
    year: '01923',
    explainMore: {
  ...
  },
  {
    id: 'to_free_store',
    type: 'tool',
    name: { en: 'Free Store', ru: 'Бесплатный магазин' },
    emojis: ['🎁', '🛍️', '🏪'],
    quote: {
      en: 'There\'s no such thing as a free lunch under capitalism — for anarchists, there\'s no other kind.',
      ru: 'При капитализме бесплатных обедов не бывает — для анархистов, никаких других и не существует.'
    },
    author: 'CrimethInc.',
    year: '02007',
    explainMore: {
  ...
  },
  {
    id: 'to_parks',
    type: 'tool',
    name: { en: 'Parks', ru: 'Парки' },
    emojis: ['🌳', '🏞️', '👫'],
    quote: {
      en: 'A shared natural or social wealth — lands, waters, forests, systems of knowledge, capacities for care — to be used by all commoners.',
      ru: 'Общее природное или социальное богатство — земли, воды, леса, системы знаний, возможности для заботы — используемое всеми членами общины.'
    },
    author: 'George Caffentzis & Silvia Federici',
    year: '02014',
    explainMore: {
  ...
  },
  {
    id: 'to_print_shop',
    type: 'tool',
    name: { en: 'Print Shop', ru: 'Типография' },
    emojis: ['🖨️', '📄', '✊'],
    quote: {
      en: 'With our intimate knowledge of the printing process, we can turn a blank sheet of paper and some ink into a tool, a gift to be shared and passed down.',
      ru: 'Благодаря нашему глубокому знанию процесса печати мы можем превратить чистый лист бумаги и немного краски в инструмент, в подарок, которым можно поделиться и передать дальше.'
    },
    author: 'Radix Media',
    year: '02010',
    explainMore: {
  ...
  },
  {
    id: 'to_self_defense',
    type: 'tool',
    name: { en: 'Self-Defense', ru: 'Самооборона' },
    emojis: ['🛡️', '✊', '🥋'],
    quote: {
      en: 'Protest is when I say I refuse to go along with this anymore. Resistance is when I make sure everybody else stops going along too.',
      ru: 'Протест — это когда я говорю, что больше не хочу с этим мириться. Сопротивление — это когда я добиваюсь, чтобы все остальные тоже перестали.'
    },
    author: 'Ulrike Maria Meinhof',
    year: '01968',
    explainMore: {
  ...
  },
  {
    id: 'to_sabotage',
    type: 'tool',
    name: { en: 'Sabotage', ru: 'Саботаж' },
    emojis: ['🔥', '⚙️', '🚫'],
    quote: {
      en: 'Freedom is the sure possession of those alone who have the courage to defend it.',
      ru: 'Свобода — надёжное достояние лишь тех, кто имеет мужество её защищать.'
    },
    author: 'Pericles',
    year: '400 BCE',
    explainMore: {
  ...
  {
    id: 'to_solidarity_clinic',
    type: 'tool',
    name: { en: 'Solidarity Clinic', ru: 'Клиника солидарности' },
    emojis: ['🏥', '💊', '❤️'],
    quote: {
      en: 'We aspire to a medical science that does not simply perceive the symptom but treats it as part of the human being as a whole.',
      ru: 'Мы стремимся к медицинской науке, которая не просто воспринимает симптом, но рассматривает его как часть человека в целом.'
    },
    author: 'Group for a Different Medicine',
    year: '02020',
    explainMore: {
  ...
  {
    id: 'to_transformative_justice',
    type: 'tool',
    name: { en: 'Transformative Justice', ru: 'Трансформативное правосудие' },
    emojis: ['⚖️', '🔄', '🌱'],
    quote: {
      en: 'We need the people within our movements, all socialized into and by unjust systems, to be on liberation paths. Not already free, but practicing freedom every day.',
      ru: 'Нам нужно, чтобы люди внутри наших движений, все социализированные в несправедливые системы и ими, шли путями освобождения. Не уже свободные, но практикующие свободу каждый день.'
    },
