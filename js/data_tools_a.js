window._TOOLS_A = [
  {
    id: 'to_broadcasts',
    type: 'tool',
    name: { en: 'Broadcasts', ru: 'Трансляции' },
    emojis: ['📡', '📻', '🌐'],
    quote: {
      en: 'We finally and suddenly arrive at the place where we must have known we were headed all along: the edge of the human.',
      ru: 'Мы наконец и внезапно оказываемся там, куда, должно быть, всегда и шли: на краю человеческого.'
    },
  ...
  {
    id: 'to_artificial_intelligence',
    type: 'tool',
    name: { en: 'Artificial Intelligence', ru: 'Искусственный интеллект' },
    emojis: ['🤖', '🧠', '🌱'],
    quote: {
      en: 'Nature [is] an unlimited broadcasting station, through which God speaks to us every hour, if we will only tune in.',
      ru: 'Природа — это безграничная радиостанция, через которую Бог говорит с нами каждый час, если только мы настраиваемся на неё.'
    },
  ...
  },
  {
    id: 'to_civic_banks',
    type: 'tool',
    name: { en: 'Civic Banks', ru: 'Гражданские банки' },
    emojis: ['🏦', '🤝', '💰'],
    quote: {
      en: 'Extension of the credit system, alike to the everyday usage of the people...betterment of environment, and improvement of population.',
      ru: 'Расширение кредитной системы, доступной для повседневного использования людьми... улучшение среды и развитие населения.'
    },
  ...
  {
    id: 'to_clothing_design',
    type: 'tool',
    name: { en: 'Clothing Design', ru: 'Дизайн одежды' },
    emojis: ['👗', '🧵', '🌿'],
    quote: {
      en: 'The material itself being living while it\'s on you....diagnosing and treating, nourishing so becoming part of your wellbeing.',
      ru: 'Сам материал живёт, пока ты его носишь... диагностирует и лечит, питает — становясь частью твоего благополучия.'
    },
    author: 'Suzanne Lee',
    year: '02017',
    explainMore: {
  ...
  {
    id: 'to_community_land_rights',
    type: 'tool',
    name: { en: 'Community Land Rights', ru: 'Права на землю сообщества' },
    emojis: ['🌍', '📜', '🏡'],
    quote: {
      en: 'In the ancient world, all revolutionary movements had a single program: cancel the debts and redistribute the land.',
      ru: 'В древнем мире все революционные движения имели единую программу: отменить долги и перераспределить землю.'
    },
  ...
  },
  {
    id: 'to_cooperatives',
    type: 'tool',
    name: { en: 'Cooperatives', ru: 'Кооперативы' },
    emojis: ['🤝', '🏭', '🌻'],
    quote: {
      en: 'We believe...the means of production should be taken from the businessmen and placed in the community.',
      ru: 'Мы считаем... что средства производства должны быть изъяты у предпринимателей и переданы обществу.'
    },
    author: 'Huey P. Newton and Bobby Seals',
    year: '01966',
    explainMore: {
  ...
  {
    id: 'to_direct_democracy',
    type: 'tool',
    name: { en: 'Direct Democracy', ru: 'Прямая демократия' },
    emojis: ['🗳️', '✊', '🏛️'],
    quote: {
      en: 'We must spread our principles, not with words, but with deeds, for this is the most irresistible form of propaganda.',
      ru: 'Мы должны распространять наши принципы не словами, а делами — это самая неотразимая форма пропаганды.'
    },
  ...
  },
  {
    id: 'to_direct_action',
    type: 'tool',
    name: { en: 'Direct Action', ru: 'Прямое действие' },
    emojis: ['✊', '🚧', '🔥'],
    quote: {
      en: 'An assembled public...can deal in a competent, face-to-face manner with the direction of public affairs.',
      ru: 'Собравшаяся публика... может компетентно и напрямую участвовать в управлении общественными делами.'
    },
  ...
  },
  {
    ...
    emojis: ['📚', '🌱', '🧑‍🏫'],
    quote: {
      en: 'Every revolutionary project is, above all an educational one.',
      ru: 'Каждый революционный проект прежде всего является образовательным.'
    },
    author: 'Murray Bookchin',
    year: '01990',
    explainMore: {
  ...
  {
    id: 'to_electoral_campaigns',
    type: 'tool',
    name: { en: 'Electoral Campaigns', ru: 'Избирательные кампании' },
    emojis: ['🗳️', '📢', '🏙️'],
    quote: {
      en: 'You may abolish this system if you will — But the new order can never be established by mere votes alone.',
      ru: 'Вы можете упразднить эту систему, если хотите — но новый порядок никогда не будет установлен одними лишь голосами.'
    },
    author: 'Eugene Debs',
    year: '01904/01910',
    explainMore: {
  ...
  },
  {
    id: 'to_family_wisdom',
    type: 'tool',
    name: { en: 'Family Wisdom', ru: 'Семейная мудрость' },
    emojis: ['👨‍👩‍👧‍👦', '📖', '🌿'],
    quote: {
      en: 'We can imagine a future in which most of life\'s material needs are provided in this way, from suitcases to lawnmowers, to speed boats.',
      ru: 'Мы можем представить будущее, в котором большинство материальных потребностей жизни обеспечивается таким образом — от чемоданов до газонокосилок и скоростных катеров.'
    },
  ...
  {
    id: 'to_equipment_library',
    type: 'tool',
    name: { en: 'Equipment Library', ru: 'Библиотека оборудования' },
    emojis: ['🔧', '📦', '🏘️'],
    quote: {
      en: 'Memory is the enemy of totalitarianism.',
      ru: 'Память — враг тоталитаризма.'
    },
    author: 'Henry Giroux',
    year: '02016',
    explainMore: {
  ...
  {
    id: 'to_general_strike',
    type: 'tool',
    name: { en: 'General Strike', ru: 'Всеобщая забастовка' },
    emojis: ['✊', '🏭', '⚡'],
    quote: {
      en: 'A strike is an incipient revolution. Many large revolutions have grown out of a small strike.',
      ru: 'Забастовка — это зарождающаяся революция. Многие великие революции выросли из небольшой забастовки.'
    },
    author: 'William \'Big Bill\' Haywood',
    year: '01911',
    explainMore: {
  ...
  {
    id: 'to_flora_fauna_identification',
    type: 'tool',
    name: { en: 'Flora/Fauna Identification', ru: 'Определение флоры и фауны' },
    emojis: ['🌿', '🦋', '🔍'],
    quote: {
      en: 'Hunter-gatherers, by nature, store information for use, understanding that there may be a time when information is scarce.',
      ru: 'Охотники-собиратели по своей природе накапливают информацию для использования, понимая, что может наступить время, когда информация будет дефицитной.'
    },
    author: 'Connor, Copeland, & Kearns',
    year: '02003',
    explainMore: {
  ...
  },
  {
    id: 'to_graffiti',
    type: 'tool',
    name: { en: 'Graffiti', ru: 'Граффити' },
    emojis: ['✍️', '🎨', '🏙️'],
    quote: {
      en: 'The most revolutionary thing one can do is always to proclaim loudly what is happening.',
      ru: 'Самое революционное, что можно сделать, — это всегда громко провозглашать то, что происходит.'
    },
  ...
  {
    id: 'to_guerilla_gardening',
    type: 'tool',
    name: { en: 'Guerilla Gardening', ru: 'Партизанское садоводство' },
    emojis: ['🌱', '🏙️', '✊'],
    quote: {
      en: 'Move quietly and plant things.',
      ru: 'Двигайся тихо и сажай всё, что можешь.'
    },
  ...
  },
  {
    id: 'to_healing_arts',
    type: 'tool',
    name: { en: 'Healing Arts', ru: 'Целительные искусства' },
    emojis: ['🌿', '💊', '🩺'],
    quote: {
      en: 'Variety of form and brilliancy of colour in the objects presented to patients have a powerful effect and are actual means of recovery.',
      ru: 'Разнообразие форм и яркость цветов в предметах, представленных пациентам, оказывают мощное воздействие и являются действительными средствами выздоровления.'
    },
  ...
  },
  {
    id: 'to_journalism',
    type: 'tool',
    name: { en: 'Journalism', ru: 'Журналистика' },
    emojis: ['📰', '📝', '🔎'],
    quote: {
      en: 'Those who tell the stories rule society.',
      ru: 'Те, кто рассказывает истории, правят обществом.'
    },
    author: 'Plato',
    year: '00375 BCE',
    explainMore: {
  ...
  },
  {
    id: 'to_library',
    type: 'tool',
    name: { en: 'Library', ru: 'Библиотека' },
    emojis: ['📚', '🏛️', '🌿'],
    quote: {
      en: 'If you have a garden in your library, everything will be complete.',
      ru: 'Если у тебя есть сад и библиотека, у тебя есть всё, что тебе нужно.'
    },
    author: 'Cicero',
    year: '46 BCE',
    explainMore: {
  ...
  },
  {
    id: 'to_laboratory',
    type: 'tool',
    name: { en: 'Laboratory', ru: 'Лаборатория' },
    emojis: ['🔬', '⚗️', '🧪'],
    quote: {
      en: 'In a solitary chamber, or rather cell, at the top of the house, and separated...by a gallery and a staircase, I kept my workshop of filthy creation.',
      ru: 'В уединённой комнате, скорее похожей на келью, на самом верху дома, отделённой... галереей и лестницей, я держал свою мастерскую грязного творчества.'
    },
  ...
  },
  {
    id: 'to_mass_protest',
    type: 'tool',
    name: { en: 'Mass Protest', ru: 'Массовый протест' },
    emojis: ['✊', '📣', '🌊'],
    quote: {
      en: 'We must always take sides. Neutrality helps the oppressor, never the victim. Silence encourages the tormentor, never the tormented.',
      ru: 'Мы всегда должны занимать позицию. Нейтралитет помогает угнетателю, но никогда — жертве. Молчание поощряет мучителя, но никогда — мучимого.'
    },
    author: 'Elie Wiesel',
    year: '01986',
    explainMore: {
  ...
  },
  {
    id: 'to_memes',
    type: 'tool',
    name: { en: 'Memes', ru: 'Мемы' },
    emojis: ['😂', '🖼️', '📱'],
    quote: {
      en: 'We steal, repurpose, re-examine, and ultimately redefine everything from celebrities to politicians, to corporate logos and redistribute these skewed ideas to the public for free.',
      ru: 'Мы воруем, перепрофилируем, переосмысляем и в конечном счёте переопределяем всё — от знаменитостей до политиков, от корпоративных логотипов — и бесплатно перераспределяем эти искажённые идеи для публики.'
    },
    author: 'David Constable',
    year: '02018',
    explainMore: {
  ...
  {
    id: 'to_off_grid_energy',
    type: 'tool',
    name: { en: 'Off-grid Energy', ru: 'Автономная энергетика' },
    emojis: ['☀️', '⚡', '🏕️'],
    quote: {
      en: 'The capitalists don\'t want anyone living off their economic grid.',
      ru: 'Капиталисты не хотят, чтобы кто-то жил вне их экономической сети.'
    },
